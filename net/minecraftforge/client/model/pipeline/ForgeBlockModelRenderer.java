...
public class ForgeBlockModelRenderer extends BlockModelRenderer
{
    ...
    @Override
    public boolean renderModelFlat(BlockRenderView world, BakedModel model, BlockState state, BlockPos pos, MatrixStack matrixStack, VertexConsumer buffer, boolean checkSides, Random rand, long seed, int p_228806_11_, IModelData modelData)
    {
    ...
    @Override
    public boolean renderModelSmooth(BlockRenderView world, BakedModel model, BlockState state, BlockPos pos, MatrixStack matrixStack, VertexConsumer buffer, boolean checkSides, Random rand, long seed, int p_228805_11_, IModelData modelData)
    {
        if(ForgeConfig.CLIENT.experimentalForgeLightPipelineEnabled.get())
        {
