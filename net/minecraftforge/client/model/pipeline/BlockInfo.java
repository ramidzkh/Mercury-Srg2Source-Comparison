...
public class BlockInfo
{
    ...
    public void updateLightMatrix()
    {
        ...
        for(Direction side : SIDES)
        {
            ...
            if(state.getOpacity(world, blockPos) == 15 || VoxelShapes.unionCoversFullCube(thisStateShape.getCullingFace(world, blockPos, side), otherStateShape.getCullingFace(world, pos, side.getOpposite())))
            {
